...
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            ...
            <input name="u_email" placeholder='账号' maxlength="16" type='text' autocomplete="off">
...
<script type="text/javascript">
    ...
    layui.use('layer', function () {
        ...
        $('input[type="button"]').click(function () {
            ...
            if (u_email == '') {
                ErroAlert('请输入您需要登录的账号');
            }else if(!reg.test(u_email)){
                ErroAlert('请输入正确的账号格式');
            }else if (u_pwd == '') {
                ErroAlert('请输入密码');
            }else {
                // //认证中..
                ...
                $.ajax({
                    ...
                    success:function(res){
                        if (res.code==200) {
                            alert(res.message);
                            location.href='http://www.educate.com/admin/index';
                        }else{
                            alert(res.message);
                        }
