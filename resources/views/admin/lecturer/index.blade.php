            ...
            {{--<tr>--}}
                ...
                {{--<td>--}}
                    {{--<div class="layui-btn-group">--}}
                        {{--<a type="button" class="layui-btn" href="/admin/addinsert">增加</a>--}}
                        {{--<a id="update" type="button" class="layui-btn" lect_id="{{ $v->lect_id }}">编辑</a>--}}
                        {{--<a id="delete" type="button" class="layui-btn" lect_id="{{ $v->lect_id }}">删除</a>--}}
                    {{--</div>--}}
                {{--</td>--}}
            {{--</tr>--}}
            {{--@endforeach--}}
