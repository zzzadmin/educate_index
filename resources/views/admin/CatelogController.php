...
class CatelogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('catelog.index',compact('course_id'));
    }

    public function cate_list(Request $request)
    {
        return view('catelog.list');
...
//        dd($where);
        ...
        if($upd){
            echo  "<script>alert('删除成功');location.href='http://www.ec.com/catelog/list';</script>";
        }
...
//        dd($sel);
        return view('catelog/upd_list',['data'=>$sel]);
    }
